...
from auto_pr import create_pr  # ⬅️ 1. Import your new PR script
...
def agent(issue_key):
    ...
    if success:
        ...
        # 🛠️ 2. Core Insertion: Create Pull Request (Pushes code & opens PR)
        print("\n📌 Step 6.5: Auto Create Remote Pull Request")
        pr_url = create_pr(issue_key, summary)
        
        print("\n📌 Step 7: Update Jira → Done")
        # Optional: You can modify update_jira_status to post the pr_url as a comment inside the ticket
